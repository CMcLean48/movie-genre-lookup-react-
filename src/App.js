...
class App extends Component {
    ...
    constructor() {
        ...
        //get current date, plus a date 4 months in past,formatted for the api query.
       // let d = new Date(),
    let d = new Date(),
		end = d.getFullYear() + '-' + `${d.getMonth() + 1}`.padStart(2, '0') + '-' + `${d.getDate()}`.padStart(2, '0');

         let e = d.setDate(d.getDate() - 120),
				start = d.getFullYear() + '-' + `${d.getMonth() + 1}`.padStart(2, '0') + '-' + `${d.getDate()}`.padStart(2, '0');
